...
class Task(Base):
    ...
    descrive = Column(String, nullable=False)
    payment_type = Column(String, nullable=False)
    price = Column(Integer, nullable=False)
    git_link = Column(String, nullable=False)
    task_status = Column(String, nullable=False)
    # owner = relationship("User_Account", back_populates="tasks")
    # task_msgs = relationship("Task_msg")
    # task_commits = relationship("Github_Commit")
    # dev_hours = relationship("Hour_Statistic")
